...
--[=[
	...
	Connects a function to the signal and returns the connection. Passes variadic arguments that will always be prepended to fired arguments.
...
function SignalMeta.Connect<T..., U...>(self: Signal<U...>, fn: (...any) -> (), ...: T...)
